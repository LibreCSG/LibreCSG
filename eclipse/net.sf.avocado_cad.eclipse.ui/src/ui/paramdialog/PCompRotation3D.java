...
public class PCompRotation3D extends ParamComp{
	...
	public PCompRotation3D(Composite parent, int style, IParam p, ParamSet paramSet){
	...
	Rotation3D getParamData(){
		try{
			Rotation3D data = (Rotation3D)param.getDataRotation3D();
			return data;
