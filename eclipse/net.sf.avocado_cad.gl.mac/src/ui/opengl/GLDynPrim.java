...
public class GLDynPrim {
	...
	public static void line3D(GL gl, IPoint3D ptA, IPoint3D ptB){
	...
	public static void line2D(GL gl, IPoint2D ptA, IPoint2D ptB, double zOffset){
		gl.glBegin(GL.GL_LINES);
	...
	private static void circle2D(GL gl, IPoint2D center, double radius, double zOffset){
		gl.glPushMatrix();
	...
	public static void arc2D(GL gl, IPoint2D center, double radius, double startAngle, double arcAngle, double zOffset){
		if(arcAngle == 360.0){
