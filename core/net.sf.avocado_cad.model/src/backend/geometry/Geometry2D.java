...
public class Geometry2D {
	 ...
	 * @return the distance
	 */
	public static double distFromLineSeg(IPoint2D ptA, IPoint2D ptB, IPoint2D ptC){
	 ...
	 * @return the distance
	 */
	public static double distFromCircle(IPoint2D ptC, double radius, IPoint2D ptX){
	 ...
	 */
	public static double threePtAngle(IPoint2D ptA, IPoint2D ptB, IPoint2D ptC){
		// angle AB
	 ...
	 */
	public static double getAnglePtToPt(IPoint2D ptA, IPoint2D ptB){
