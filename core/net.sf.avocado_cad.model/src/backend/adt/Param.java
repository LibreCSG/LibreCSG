...
public class Param implements IParam {
	...
	public final ParamType  ptype;
	public String plabel;
	public Object pdata;
	public boolean derivedParam = false;
	 ...
	 */
	public Param(String label, IPoint2D data){
		pdata  = data;
		plabel = label;
		ptype  = ParamType.Point2D;
	}
	
	public Param(String label, IPoint3D data){
		pdata  = data;
		plabel = label;
		ptype  = ParamType.Point3D;
	}
	
	public Param(String label, IRotation3D data){
		pdata  = data;
		plabel = label;
	...
	public Param(String label, ISelectionList data){
		pdata  = data;
		plabel = label;
