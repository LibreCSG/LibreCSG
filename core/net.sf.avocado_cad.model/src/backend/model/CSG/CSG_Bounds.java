...
import net.sf.avocado_cad.model.api.csg.ICSGBounds;
 ...
 */
public class CSG_Bounds implements ICSGBounds {
	...
	public CSG_Bounds(ICSGVertex firstVertex){
	 ...
	 */
	public void includeVertex(ICSGVertex v){
	...
	public ICSGVertex getBoundCenter(){
