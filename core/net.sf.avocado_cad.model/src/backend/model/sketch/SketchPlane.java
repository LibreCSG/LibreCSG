 ...
 */
public class SketchPlane implements ISketchPlane {

	public CSG_Vertex origin;
	public CSG_Vertex normal;
	public CSG_Vertex xAxis;
	public ICSGVertex yAxis;
	...
	*/
	 ...
	 */
	private CSG_Vertex getXAxisFromNormal(ICSGVertex normal){
	...
	public double getRotationY(){
		...
		IRotation3D rotation       = new Rotation3D(rotX, 0.0, 0.0);
		ITranslation3D translation = new Translation3D(0.0, 0.0, 0.0); 
		ICSGVertex newZAxis    = new CSG_Vertex(0.0, 0.0, 1.0).getTranslatedRotatedCopy(translation, rotation);
		ICSGVertex newXAxis    = new CSG_Vertex(1.0, 0.0, 0.0).getTranslatedRotatedCopy(translation, rotation);
	...
	public double getRotationZ(){
		...
		IRotation3D rotation       = new Rotation3D(rotX, rotY, 0.0);
		ITranslation3D translation = new Translation3D(0.0, 0.0, 0.0);
		ICSGVertex newXAxis    = new CSG_Vertex(1.0, 0.0, 0.0).getTranslatedRotatedCopy(translation, rotation);
		ICSGVertex newYAxis    = new CSG_Vertex(0.0, 1.0, 0.0).getTranslatedRotatedCopy(translation, rotation);
