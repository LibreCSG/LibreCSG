...
* @created Feb. 2007
*/
public abstract class Prim2D implements IPrim2D{
	 ...
	 */
	abstract public Point2D intersect(IPrim2D anyPrim2D);
	 ...
	 */
	abstract public Point2D intersectsLine(IPrim2DLine ln);
	 ...
	 * @return the point of intersection, or NULL if no intersection.
	 */
	abstract public Point2D intersectsArc(IPrim2DArc arc);
	 ...
	 * @return the distance
	 */
	abstract public double distFromPrim(IPoint2D pt);	
	 ...
	 */
	abstract public PrimPair2D splitPrimAtPoint(IPoint2D pt);	
	 ...
	 */
	public Point2D hasPtGetOther(IPoint2D ptC){
		if(ptA.equalsPt(ptC)){
			return ptB;
		}
		if(ptB.equalsPt(ptC)){
