...
* Install System Dependencies
  * Fedora: `sudo dnf -y install eclipse-jdt java-1.8.0-openjdk-devel maven`
  ...
  (seemed to make following error shorter...)
  The 'org.eclipse.recommenders.completion.rcp.javaCompletionProposalComputer.intelligent' proposal computer from the 'org.eclipse.recommenders.completion.rcp' plug-in did not complete normally. Unable to instantiate the extension.
  To avoid this message, disable the 'org.eclipse.recommenders.completion.rcp' plug-in or disable the 'Java Proposals (Code Recommenders)' category on the content assist preferences page.
