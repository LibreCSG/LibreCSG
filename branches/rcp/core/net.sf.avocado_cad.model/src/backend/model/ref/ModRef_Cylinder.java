...
public class ModRef_Cylinder extends ModelReference{
	...
	private final ICSGVertex centerPoint;
	private final ICSGVertex normal;
	 ...
	 */
	public ModRef_Cylinder(int uniqueSubPartID, int uniqueFaceID, ICSGVertex centerPoint, ICSGVertex normal, double radius){
	...
	public ICSGVertex getCenterPoint(){
		return centerPoint;
	}
