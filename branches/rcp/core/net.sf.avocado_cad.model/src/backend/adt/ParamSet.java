...
import net.sf.avocado_cad.model.api.adt.ParamNotFoundException;
...
public class ParamSet implements IParamSet {
	...
	public String label;
	public LinkedHashMap <String,Param>paramSet = new LinkedHashMap<String,Param>();
