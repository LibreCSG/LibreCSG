...
public interface ToolCtrl {
	 ...
	 */
	abstract public void glMouseDown(double x, double y, double z, MouseEvent e, IParamSet paramSet);
	 ...
	 * @param e mouseEvent (useful for key state, button pressed, etc.)
	 */
	abstract public void glMouseDrag(double x, double y, double z,  MouseEvent e, IParamSet paramSet);
	 ...
	 * @param e mouseEvent (useful for key state, button pressed, etc.)
	 */
	abstract public void glMouseMovedUp(double x, double y, double z,  MouseEvent e, IParamSet paramSet);
	 ...
	 * @param e mouseEvent (useful for key state, button pressed, etc.)
	 */
	abstract public void glMouseUp(double x, double y, double z,  MouseEvent e, IParamSet paramSet);
	
	abstract public void glKeyPressed(KeyEvent e, boolean ctrlIsDown, boolean shiftIsDown, IParamSet paramSet);
