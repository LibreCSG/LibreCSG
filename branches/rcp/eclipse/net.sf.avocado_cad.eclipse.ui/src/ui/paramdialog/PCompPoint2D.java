...
public class PCompPoint2D extends ParamComp{
	...
	public PCompPoint2D(Composite parent, int style, IParam p, ParamSet paramSet){
	...
	Point2D getParamData(){
		try{
			Point2D data = (Point2D)param.getDataPoint2D();
			return data;
